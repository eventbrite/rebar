...
# sphinx-quickstart on Mon Sep 16 11:32:50 2013.
#
...
latex_documents = [
  ('index', 'Rebar.tex', u'Rebar Documentation',
...
man_pages = [
    ('index', 'rebar', u'Rebar Documentation',
     [u'Nathan Yergler'], 1)
]
...
texinfo_documents = [
  ('index', 'Rebar', u'Rebar Documentation',
   u'Nathan Yergler', 'Rebar', 'One line description of project.',
   'Miscellaneous'),
]
